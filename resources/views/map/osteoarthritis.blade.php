...
<h1>การประเมินสุขภาพผู้สูงอายุ(ข้อเข่าเสื่อม)</h1>
<div class="row">
						...
						'<tr>'+
							'<td colspan=\"2\" style=\"border: 0px;padding-top: 1px;text-align: right;\">'+
								'<table class=\"table table-bordered table-striped"\">'+
									...
									'</tr>';
									var isTrue = true, icon = "images/green.png";
									dataPatient[data.homeNo].forEach(function(patient) {
										if(isTrue && (patient.color == 4 || patient.color == 5 || patient.color == 6)){
											icon = "images/red.png";
											isTrue = false;
										}
										content += '<tr style=\"background-color:'+getColor(patient.color)+';\">'+
											'<td>'+patient.name+'</td>'+
