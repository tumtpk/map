...
@section('title', 'การดำเนินชีวิตประจำวัน')
...
<h1>การประเมินสุขภาพผู้สูงอายุ(การดำเนินชีวิตประจำวัน)</h1>
<div class="row">
...
@section('js')
	...
	<script>
		...
		function myMap() {
							...
							'<td colspan=\"2\" style=\"border: 0px;padding-top: 1px;text-align: right;\">'+
								'<table class=\"table table-bordered table-striped"\">'+
									...
									dataPatient[data.homeNo].forEach(function(patient) {
										arrColor.push(patient.color);
										if(patient.color == 1){
											color = 'rgba(0, 255, 20, 0.24)';
										}else if(patient.color == 2){
											color = 'rgba(255, 212, 0, 0.24)';
										}else{
			...
			function getIcon(arrColor){
				var color = Math.max.apply(Math,arrColor);
				if(color == 1){
